...
final class CreateNewsV1Index implements MigrationInterface
{
    /**
     * Run the migration.
     */
    ...
    {
        Index::create('news_v1', function (Mapping $mapping, Settings $settings) {
            $settings->analysis([
                'normalizer' => [
            ...
            $mapping->keyword('tags_title', [
                'normalizer' => 'lowercase_normalizer',
            ]);

            $mapping->nested('tags', function (MappingProperties $properties) {
                $properties->long('id');
                $properties->keyword('title', ['normalizer' => 'lowercase_normalizer']);
                $properties->keyword('slug', ['normalizer' => 'lowercase_normalizer']);
